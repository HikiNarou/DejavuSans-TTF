# XjZRwDSyDMrYH8G3NPf9kILju75rUw
# PxMSaXTl4WT4N6jcHypypuFH
import sys, os, time, random, ctypes, json, threading
# vEk6OFeWpHltpXpcHRueGzab0Rg
from multiprocessing import Process, Queue
import cv2, numpy as np, pyautogui
# 1rYV9yEzBEFprMLeW1MN8PW
import win32api, win32con
from PyQt5 import QtWidgets, QtCore, QtGui
# 3oHaAiig5Wo7thdakOFvc
import bettercam

# Global shutdown event used by the trigger bot process.
shutdown_event = threading.Event()
# 2urE2mQKM5uX1xM2u3n86V7MGjaLk7# UI-DO-NOT-OBFUSCATE-START
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def create_ui(self):
        ...
        title_label = QtWidgets.QLabel("GamerFun Valo 1.1")
